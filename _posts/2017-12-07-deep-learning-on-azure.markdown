---
title: "Deep Learning on Azure, with Keras, Theano and CUDA GPUs"
layout: post
...
description: How I used Azure to run Deep Learning experiments implemented with Keras and Theano, using CUDA GPUs
---
